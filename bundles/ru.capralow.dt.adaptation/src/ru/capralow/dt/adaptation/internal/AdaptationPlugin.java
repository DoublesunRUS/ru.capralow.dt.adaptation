...
public class AdaptationPlugin
    extends Plugin
{
    public static final String ID = "ru.capralow.dt.adaptation"; //$NON-NLS-1$

    private static AdaptationPlugin instance;
    ...
    public static AdaptationPlugin getInstance()
    {
        return instance;
    }
